...
public class AlunoRepository {
	...
	public List<Aluno> listAlunos(String matricula, String nome, Integer rg, Integer telefone){
		...
		if(telefone != null) {
			jpql.append("(a.telefone.numeroCelular LIKE :celulcar OR a.telefone.numeroFixo LIKE :fixo)AND");		
		}
		jpql.append("1 = 1");
	...
	public List<Acesso> listAcessosAlunos(String matricula,LocalDate dataInicial,LocalDate dataFinal){
		...
		if(dataFinal != null) {
		LocalDateTime ldt = LocalDateTime.of(dataFinal, LocalTime.of(23,59,59, 0));
